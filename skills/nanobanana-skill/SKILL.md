...
2. **Python3 with depedent packages installed**: google-genai, Pillow, python-dotenv. They could be installed via `python3 -m pip install -r ~/.config/codex/skills/nanobanana-skill/requirements.txt` if not installed yet.
3. **Executable**: `~/.config/codex/skills/nanobanana-skill/nanobanana.py`
...
2. Run the nanobanana script with appropriate parameters:
   ...
   ```bash
   python3 ~/.config/codex/skills/nanobanana-skill/nanobanana.py --prompt "description of image" --output "filename.png"
   ```
...
2. Run with input images:
   ...
   ```bash
   python3 ~/.config/codex/skills/nanobanana-skill/nanobanana.py --prompt "editing instructions" --input image1.png image2.png --output "edited.png"
   ```
...
```bash
python3 ~/.config/codex/skills/nanobanana-skill/nanobanana.py --prompt "A serene mountain landscape at sunset with a lake"
```

### Generate with specific size and output

```bash
python3 ~/.config/codex/skills/nanobanana-skill/nanobanana.py \
