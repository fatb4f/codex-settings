...
# Show help
~/.config/codex/skills/autonomous-skill/scripts/run-session.sh --help
```
...
~/.config/codex/skills/autonomous-skill/scripts/run-session.sh --task-name build-rest-api-todo --continue --resume-last
```
...
~/.config/codex/skills/autonomous-skill/scripts/run-session.sh --network "Fetch data from GitHub API and analyze"
```
